...
def generate_speech(text_chunks, output_dir, completed_chunks, progress_file):
    ...
    for idx, chunk in enumerate(text_chunks):
        ...
        # Eğer dosya zaten tamamlandıysa atla
        ...
        try:
            ...
            # Başarıyla tamamlanan dosyayı kaydet
...
docx_files = ["Managing Storeroom Inventory.docx", "Maximo 7.6 New Features.docx", "Multi-Organization and Site Setup.docx", "Workforce Management.docx"]  # Buraya işlemek istediğiniz dosyaların yollarını ekleyin
